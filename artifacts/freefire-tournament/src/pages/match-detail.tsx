...
import { Users, Trophy, Clock, Flame, Copy, CheckCircle2, Loader2, ArrowLeft, MessageCircle, QrCode } from "lucide-react";
...
export function MatchDetail() {
  ...
  const isPlayerRegistered = player && (match as any).registrations?.some((r: any) => r.playerId === player.id);
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            <h1 className="text-2xl font-extrabold tracking-wide mb-3" data-testid="text-match-title">{match.title}</h1>
          ...
          {/* Top 3 Winners - only when completed and ranks assigned */}
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-2">
                {(match as any).registrations.map((reg: any, i: number) => (
                  <div key={reg.id} data-testid={`row-player-${reg.id}`} className="flex items-center justify-between py-2 border-b border-border/50 last:border-0">
          ...
          <div className="bg-card border border-border rounded-xl p-6 sticky top-20">
            ...
            {isPlayerRegistered ? (
              <div className="text-center py-4">
                ...
                <p className="text-xs text-muted-foreground mt-2">Payment confirm hone ke baad aapka slot pakka ho jayega.</p>
              </div>
            ) : registrationSuccess ? (
              <div className="text-center py-4">
                <CheckCircle2 className="w-10 h-10 text-green-400 mx-auto mb-3" />
                <p className="font-bold text-green-400">Registration Successful!</p>
                <p className="text-xs text-muted-foreground mt-2">Niche UPI se payment karo aur WhatsApp pe screenshot bhejo.</p>
              </div>
            ) : (
              <>
                {!isUpcoming ? (
            ...
            <div className="mt-5 pt-5 border-t border-border">
              ...
              <div className="bg-background rounded-lg p-3 mb-3">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button onClick={copyUpi} className="text-muted-foreground hover:text-primary transition-colors" data-testid="button-copy-upi">
              ...
              >
                ...
                Payment ke baad WhatsApp pe screenshot bhejo
              </a>
            </div>
          </div>
        </div>
